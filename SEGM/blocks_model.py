"""This module is derived from the ``model`` Blocks module in the SGNMT
    framework. It contains the ``NMTModel`` class which is the main
    interface to the NMT implementations in Blocks with a different
    initialization of model parameters (Identity)
    """
