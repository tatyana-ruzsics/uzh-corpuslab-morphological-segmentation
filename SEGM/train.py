""""This script starts training an NMT system with blocks
    and follows the SGNMT train module cam.sgnmt.train.py
    but relies on a different configuration and evaluation
    from trainers.py
"""
...
#        Printing(after_batch=True),
    ...
    if config['bleu_script'] is not None:
        ...
        extensions.append(
             AccValidator(nmt_model.sampling_input,
