"""This module is directly taken  from the ``vanilla_decoder`` Blocks 
    module in the SGNMT framework. It relies on NMTModel and LoadNMTUtils
    classes from blocks_model script.
"""

from blocks_model import NMTModel, LoadNMTUtils
