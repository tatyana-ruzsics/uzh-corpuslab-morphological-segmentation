#!/usr/bin/python
# -*- coding: utf-8 -*-
"""This is the main runner script for morphological segmentation
    (cED+LM) decoding.
This script is identical to SGNMT decoder cam.sgnmt.decode.py
but relies on different decoding utils from decode_utils_segm.py
adapted for morphological segmentation.
"""
